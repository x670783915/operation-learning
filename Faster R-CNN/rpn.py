...
class AnchorGenerator(nn.Module):
    ...
    def forward(self, image_list, feature_maps):
        ...
        anchors = [torch.cat(anchors_per_feature_map) for anchors_per_feature_map in anchors]
        return anchors
...
class RegionProposalNetwork(torch.nn.Module):
    ...
    def __init__(
        ...
        batch_size_per_image, positive_feaction,
        pre_nms_top_n, post_nms_top_n, nms_thresh
    ):
        super(RegionProposalNetwork, self).__init__()
        self.anchor_generator = anchor_generator
        self.head = head
        self.box_coder = det_utils.BoxCoder(weight=(1.0, 1.0, 1.0))
    ...
    def forward(self, images, features, targets=None):
        ...
        boxes, scores = self.filter_proposals(proposals, objectness, images.image_shapes, num_anchors_per_level)
