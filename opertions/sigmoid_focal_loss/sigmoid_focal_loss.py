...
class SigmoidFocalLossFunctin(Function):
    ...
    def forward(ctx, input, target, gamma=2.0, alpha=0.25):
        ...
        loss = sigmoid_focal_loss_cuda(input, target, num_classes, gamma, alpha)
...
sigmoid_focal_loss = SigmoidFocalLossFunctin.apply
